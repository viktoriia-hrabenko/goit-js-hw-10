...
formInput.addEventListener("input", (0, _lodashDebounceDefault.default)(onSearchedCountry, DEBOUNCE_DELAY));
...
function onSearchedCountry(event) {
    ...
    (0, _fetchCountries.fetchCountries)(countryToFind).then((country)=>{
...
},{"./css/styles.css":"1CY4s","notiflix":"5WWYd","lodash.debounce":"3JP5n","./js/fetchCountries":"dKuy9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"5WWYd":[function(require,module,exports) {
var global = arguments[3];
